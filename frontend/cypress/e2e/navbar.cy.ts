describe('Navbar', () => {
    ...
    it('should persist navbar across pages', () => {
        ...
        cy.get('[data-testid="navbar"]').should('be.visible');
        cy.get('[data-testid="navbar"]').contains('SantaMatch').should('be.visible');
    });
    ...
    it('is responsive and shows menu on mobile', () => {
        ...
        cy.get('[data-testid="mobile-menu-button"]').contains('Menu').should('be.visible');
        cy.get('[data-testid="mobile-menu-button"]').click();
        cy.get('[data-testid="mobile-menu-button"]').contains('Close').should('be.visible');
        cy.get('[data-testid="mobile-navbar"]').contains('Create Group').should('be.visible');
        cy.get('[data-testid="mobile-navbar"]').contains('View Match').should('be.visible');
        cy.get('[data-testid="mobile-menu-button"]').click();
        cy.contains('Create Group').should('not.be.visible');
      });
  });