describe('Privacy Policy Page', () => {
    ...
    it('displays the effective date', () => {
      cy.contains('Effective Date: December 30, 2025')
        .should('be.visible');
    });
  
    it('shows the information collection section', () => {
      cy.contains('Information Collection And Use')
        .should('be.visible');
  
      cy.contains('SantaMatch values your privacy')
        .should('be.visible');
    });
  
    it('lists third-party services', () => {
      cy.contains('Third-Party Hosting and Services')
        .should('be.visible');
    ...
    it('shows contact email', () => {
      cy.contains('carlahau110@gmail.com')
        .should('be.visible');
    });
