...
const contentSections = [
  ...
  },
  {
    ...
    content: (
      <div>
        <p>SantaMatch uses third-party hosting platforms to operate the service:</p>
        <ul className="list-disc pl-5 space-y-1">
          <li>Vercel for the frontend</li>
          <li>Render for the backend</li>
          <li>Neon for database</li>
        </ul>
        <p>These providers may process operational data necessary to deliver the service, such as server logs, request metadata, error reports, performance metrics, and database operations. No personal data is intentionally shared with these providers for marketing or analytics purposes. All operational data is handled according to the providers’ privacy and security policies.</p>
      </div>
    )
  },
  {
