  ...
  return (
    <div className="fixed w-full justify-center items-center flex flex-col mt-10">
      <nav className="bg-sky-200 mx-auto p-4 px-10 sticky z-50 rounded-full md:w-[65%] w-[90%]">
        <div data-testid="navbar" className="mx-auto flex justify-between items-center">
          ...
          <div className="md:hidden">
            <button data-testid="mobile-menu-button" onClick={() => setIsMenuOpen(!isMenuOpen)}>
      ...
      <div className="fixed md:w-[65%] mt-30 rounded-b-xl w-[90%] bg-sky-200/50">
        {isMenuOpen && (
          <div data-testid="mobile-navbar" className="flex md:hidden mt-10 mb-3 px-10 flex-col items-end">
            {navItems.map((item) => (
